...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="<?php  echo "http://".$_SERVER['HTTP_HOST']; ?>/intranetCESI/vues/index.php" class="w3-bar-item w3-button w3-padding-large w3-theme-d4"><img style='height : 23px; width:auto;' src='<?php echo "http://".$_SERVER['HTTP_HOST']; ?>/intranetCESI/vues/images/logoCesi.jpg' /></a>
